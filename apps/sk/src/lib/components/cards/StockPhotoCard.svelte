...
<div class="bg-white flex flex-col justify-center items-center p-10 rounded">
  {#if currentQuestion?.content && hasValidImageData}
    <h1 class="text-2xl md:text-4xl font-bold mb-2">Is this image real?</h1>
    <div class="flex flex-col justify-center m-2 w-fit h-100">
      ...
      <div class="flex flex-row gap-4">
        <Button
          ...
          class="bg-gray-800 hover:bg-green-500 text-m md:text-xl text-white  font-bold w-full h-16"
        >
          REAL
        </Button>
        ...
        <Button
          ...
          class="bg-gray-800 hover:bg-red-500 text-m md:text-xl text-white  font-bold w-full h-16"
        >
          AI-GENERATED
        </Button>
      </div>
